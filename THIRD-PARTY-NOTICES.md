...
Monica uses third-party components distributed under their respective licenses.

## KPCLib 2.0.4 and KeePassLib

KPCLib is a .NET Standard build of KeePassLib maintained by Roger Ye. KeePassLib was created by Dominik Reichl.

- Package: `KPCLib` version `2.0.4`
- License: GNU Lesser General Public License v3.0 or later
- Project: <https://passxyz.github.io/>
